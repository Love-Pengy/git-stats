...
int main()
{
	...
	boardingPass b1 =
		createBoardingPass(rand() % 1000, "b1First", "b1Last");
	boardingPass b2 =
		createBoardingPass(rand() % 1000, "b2First", "b2Last");
	boardingPass b3 =
		createBoardingPass(rand() % 1000, "b3First", "b3Last");
	boardingPass b4 =
		createBoardingPass(rand() % 1000, "b4First", "b4Last");
	boardingPass b5 =
		createBoardingPass(rand() % 1000, "b5First", "b5Last");
	...
	printf("%s\n", boardingPassToString(
			       findValueHT(test, "somethingthatisn'tinit:3")));
